...
GpuMonitor::GpuMonitor(QObject* parent) : QObject(parent) { TopEngine::ensureStarted(); }
...
SensorsMonitor::SensorsMonitor(QObject* parent) : QObject(parent) { TopEngine::ensureStarted(); }
