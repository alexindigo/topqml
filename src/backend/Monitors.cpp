...
CpuMonitor::CpuMonitor(QObject* parent) : QObject(parent) { TopEngine::ensureStarted(); }
...
MemMonitor::MemMonitor(QObject* parent) : QObject(parent) { TopEngine::ensureStarted(); }
